...
**Purpose:** This document instructs Claude AI on how to analyze practice session results, track learner progress, and deliver adaptive lessons for target-language writing practice. Language-agnostic — applies to whatever `target_language` is set in `learner-profile.json` (German, by default in this repo).
...
**Your answer:** [Student's target-language answer]
**Correct answer:** [Correct target-language answer]
...
### Translation
**Example:** "Write in German: I am writing to you because I have a question"
...
- **Wrong word order in clauses** → Incomprehensible sentence
